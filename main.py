...
#
# neurons = [Neuron(Bird(100))]
# neurons[0].w1 = 0.7565577796815881
# neurons[0].w2 = 0.059116350021553465
# neurons[0].w3 = -0.08993134298486605
# neurons[0].w4 = -0.930392205899921
...
while running:
    ...
    if mode == 1:
        ...
        if death == NEURON_NUMBER:
            ...
            best = neurons[:10]
            thebest = neurons[0]
            pygame.display.set_caption(f"GENERATION {generation} Weight: w1:{thebest.w1} w2:{thebest.w2} w3:{thebest.w3} w4:{thebest.w4} BEST FITNESS: {round(thebest.bird.fitness, 2)}")
            generation += 1
            new_neurons = []
            for _ in range(90):
